...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full md:pt-36 pt-20 px-7 md:px-0 space-y-7 text-center bg-linear-to-b from-white-100 to-white'>
      ...
      <h1 className="md:text-home-heading-large text-home-heading-small relative font-bold text-gray-800 max-w-6xl mx-auto leading-tight">
        Build your future with
        <br />
        <span className="text-blue-900 md:text-[48px] text-[32px] whitespace-nowrap">
